"""PyTMGenerator.py -- Self-contained threat model generator for the pipeline.
...
class PyTMGenerator:
    ...
    def __init__(
        ...
        logger.info(
            "PyTMGenerator initialised: %d kind mappings, %d label flips, "
    ...
    def _match_elements(
        ...
        before_map: dict[str, K8sElement] = {
            PyTMGenerator._element_key(e): e for e in before_model.elements
        }
        after_map: dict[str, K8sElement] = {
            PyTMGenerator._element_key(e): e for e in after_model.elements
        }
